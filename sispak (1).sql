...
--
-- Host: localhost
-- Generation Time: Jun 24, 2022 at 10:23 AM
...
(1, 3, 8, 13, 17, 22, 27, 32, 36, 37, 39, 7.8740078740118, 3),
(2, 5, 8, 13, 18, 23, 28, 30, 34, 38, 40, 0, 2),
(3, 4, 8, 13, 18, 23, 27, 30, 35, 37, 40, 0, 3),
(4, 4, 8, 13, 18, 23, 27, 30, 35, 37, 40, 5.4772255750517, 3),
(5, 3, 8, 13, 18, 23, 26, 30, 35, 37, 39, 4.4721359549996, 2),
(6, 3, 8, 13, 18, 23, 26, 30, 35, 37, 39, 4.4721359549996, 2);
...
(1, 1, 0, 0, 1, 0, 0, 4, 9, 1, 1, 4.1231056256177, 3),
(2, 0, 0, 0, 0, 1, 1, 0, 1, 0, 4, 2.6457513110646, 2),
(3, 0, 0, 0, 0, 1, 0, 0, 4, 1, 4, 3.1622776601684, 3),
(4, 0, 0, 0, 0, 1, 0, 0, 4, 1, 4, 3.1622776601684, 3);
...
--
ALTER TABLE `tb_pengetahuan`
  MODIFY `id_pengetahuan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tb_temp`
  MODIFY `id_temp` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
