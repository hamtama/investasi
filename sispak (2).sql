...
--
-- Host: localhost
-- Generation Time: Jul 10, 2022 at 04:55 PM
...
(85, 3, 9, 13, 19, 22, 27, 30, 35, 37, 40, 2, 2),
(86, 3, 9, 13, 19, 22, 27, 30, 35, 37, 40, NULL, NULL),
(87, 3, 9, 13, 19, 22, 27, 30, 35, 37, 40, NULL, NULL);
...
INSERT INTO `tb_temp` (`id_temp`, `n_temp_1`, `n_temp_2`, `n_temp_3`, `n_temp_4`, `n_temp_5`, `n_temp_6`, `n_temp_7`, `n_temp_8`, `n_temp_9`, `n_temp_10`, `total_temp`, `id_kategori`) VALUES
(1, 1, 1, 1, 4, 9, 1, 4, 1, 1, 0, 4.7958315233127, 3),
(2, 0, 4, 4, 4, 1, 0, 1, 0, 1, 1, 4, 3),
(3, 1, 1, 9, 0, 4, 1, 4, 1, 1, 0, 4.6904157598234, 3),
(4, 1, 1, 1, 1, 9, 1, 9, 0, 1, 1, 5, 3),
(5, 1, 1, 4, 0, 0, 0, 1, 1, 0, 0, 2.8284271247462, 2),
(6, 1, 0, 0, 1, 1, 0, 0, 0, 0, 1, 2, 2),
(7, 1, 1, 0, 1, 1, 1, 1, 1, 1, 0, 2.8284271247462, 2),
(8, 0, 4, 0, 4, 4, 0, 4, 1, 1, 1, 4.3588989435407, 2),
(9, 0, 1, 1, 0, 1, 1, 9, 0, 0, 0, 3.605551275464, 4),
(10, 1, 0, 4, 0, 1, 0, 4, 1, 0, 0, 3.3166247903554, 4),
(11, 1, 1, 0, 4, 0, 0, 9, 1, 0, 1, 4.1231056256177, 4),
(12, 1, 1, 1, 1, 9, 1, 1, 0, 0, 0, 3.8729833462074, 4),
(13, 1, 1, 4, 1, 4, 1, 4, 1, 0, 0, 4.1231056256177, 1),
(14, 1, 1, 1, 0, 1, 1, 1, 0, 0, 1, 2.6457513110646, 1),
(15, 1, 1, 4, 0, 1, 0, 4, 0, 1, 0, 3.4641016151378, 1),
(16, 1, 4, 1, 1, 9, 0, 4, 1, 1, 0, 4.6904157598234, 1),
(17, 0, 0, 0, 4, 0, 0, 1, 1, 0, 1, 2.6457513110646, 5),
(18, 1, 1, 0, 1, 1, 1, 0, 1, 0, 1, 2.6457513110646, 5),
(19, 0, 4, 0, 1, 0, 1, 1, 0, 0, 0, 2.6457513110646, 5),
(20, 1, 1, 1, 0, 0, 0, 1, 1, 0, 1, 2.4494897427832, 5),
...
--
ALTER TABLE `tb_pengetahuan`
  MODIFY `id_pengetahuan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
ALTER TABLE `tb_temp`
  MODIFY `id_temp` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
COMMIT;
