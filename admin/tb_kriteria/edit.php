...
<form action="aksiedit.php" method="post" role="form">
    <div class="form-group field item row">
        ...
        <div class="col-md-6 col-sm-6">
            <input type="hidden" name="id" value="<?php echo $baris['id_kriteria'] ?>">
            <input type="text" name="kriteria" value="<?php echo $baris['kriteria'] ?>" required="required"
    ...
    <div class="form-group field item row">
        ...
        <div class="col-md-6 col-sm-6">
            <textarea class="form-control" name="pertanyaan" id="" cols="30"
                rows="5"><?= $baris['pertanyaan'] ?></textarea>
        </div>
    </div>
