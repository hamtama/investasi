	...
	<form action="aksiedit.php" method="post" role="form">
		<div class="form-group field item row" >
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <input type="text" name="nilai" value="<?php echo $baris['nilai_bobot'] ?>" required="required" class="form-control has-feedback-left">
        ...
        <div class="form-group field item row" >
            ...
            <div class="col-md-6 col-sm-6">
                <input type="text" name="status" value="<?php echo $baris['status_bobot'] ?>" required="required" class="form-control has-feedback-left">
