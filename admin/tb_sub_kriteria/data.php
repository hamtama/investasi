                            ...
                            <div class="card-box">
                                <table id="datatable-responsive"
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $query = "SELECT * FROM tb_sub_kriteria 
                                        left join tb_kriteria ON tb_kriteria.id_kriteria = tb_sub_kriteria.id_kriteria 
                                        left join tb_skala ON tb_skala.id_skala = tb_sub_kriteria.id_skala Order By id_sub_kriteria DESC";
                                        $sql_kriteria = mysqli_query($mysqli, $query) or die(mysqli_error($query));
                                        if (mysqli_num_rows($sql_kriteria) > 0) {
                                        ...
                                        <tr>
                                            <td style="width:10%">
                                                <a class="btn btn-warning btn-xs" data-toggle="modal" href="#myModal"
                                                    ...
                                                    data-id="<?= $row['id_sub_kriteria'] ?>"><i
                                                        class="fa fa-pencil"></i></a>
                                                <button class="btn btn-danger btn-xs"
                                                    onclick="javascript:delete_id(<?= $row['id_sub_kriteria'] ?>)"><i
                                ...
                                <div class="modal fade bs-example-modal-lg" id="myModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Edit Data Sub Kriteria</h4>
                                                <button type="button" class="close" data-dismiss="modal"><span
                                                        aria-hidden="true">×</span>
                                                </button>
                                            </div>
