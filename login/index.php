                    ...
                    <div id="login">
                        <form action="index.php" method="post" autocomplete="off">
                            ...
                            <div>
                                ...
                                <a href="../users/dashboard/data.php" class="btn btn-app"><i
                                        class="fa fa-user"></i>Diagnosis</a>
                            </div>
                            ...
                            <div class="separator">
                                ...
                                <div>
                                    ...
                                    <p>©2020 All Rights Reserved. Gentelella Alela! is a Bootstrap 3 template. Privacy
                                        and
                                        Terms</p>
                                </div>
                            </div>
            ...
            <div id="register" class="animate form registration_form">
                <section class="login_content">
                    <form action="index.php" method="post" autocomplete="off">
                        ...
                        <div>
                            <button type="submit" class="btn btn-app" name="register"> <i class="fa fa-sign-in"></i>
                                Simpan</button>
                        </div>
                        <div class="clearfix"></div>
                        <div class="separator">
                            ...
                            <div class="profile clearfix">
                                <div class="profile_pic">
                                    <img src="../assets/images/wesngonotok3.png" alt="..." style="height: 100px;">
                                </div>
                                <div class="profile_info">
                                    <h1>SPK Ansuransi Apps</h1>
                                </div>
                            </div>
                            <div>
